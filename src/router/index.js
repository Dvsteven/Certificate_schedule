...
// import AdminAgenda from '../views/viewsAdmin/AdminAgenda.vue'
...
const routes = [
  ...
  // Rutas de admin
  {
    path: '/viewsAdmin/dashboard',
    name: 'AdminDashboard',
    component: AdminDashboard,
    meta: { requiresAuth: true }
  },
  {
    path: '/viewsAdmin/usuarios',
    name: 'Usuarios',
    component: Usuarios,
    meta: { requiresAuth: true }
  }
  // {
  //   path: '/viewsAdmin/licencias',
  //   name: 'Licencias',
  //   component: Licencias,
  //   meta: { requiresAuth: true }
  // },
  // {
  //   path: '/viewsAdmin/certificados',
  //   name: 'Certificados',
  //   component: Certificados,
  //   meta: { requiresAuth: true }
  // },
  // {
  //   path: '/viewsAdmin/reportes',
  //   name: 'Reportes',
  //   component: Reportes,
  //   meta: { requiresAuth: true }
  // },
  // {
  //   path: '/viewsAdmin/agenda',
  //   name: 'AdminAgenda',
